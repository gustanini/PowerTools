function Get-TrustTicket{
    ...
    Write-Host "Mimikatz TGT + Kekeo TGS" -ForegroundColor Cyan 
    Write-Host $mimiTGT`n$kekeoTGS

    Write-Host "Rubeus" -ForegroundColor Cyan
    Write-Host $rubeusTGT`n$rubeusTGS
}